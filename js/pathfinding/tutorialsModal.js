...
function tutorialDisplay() {
    ...
    if (tutorialPage == 1) {
        ...
        tutorialBody.innerHTML = "<div class='tutorial-header'><h1>Pick An Algorithm <sup> 2/6</sup></h1></div><h2>Choose Any Algorithm out of 5</h2><h3>After choosing algorithm click on Visulize button</h3><br><img src='../img/pathfinding_tutorial/algo.png' alt='demo image' id='tutorial-img'>";

    } else if (tutorialPage == 3) {
        tutorialBody.innerHTML = "<div class='tutorial-header'><h1>Add Walls <sup> 3/6</sup></h1></div><h2>Turn your Imagination into reality and explore different cases</h2><h3>Click or Drag on any cell on grid to make it as wall ,reclick on cell to make it disapper</h3><br><img src='../img/pathfinding_tutorial/wall.gif' alt='demo image' id='tutorial-img'>";

    } else if (tutorialPage == 4) {
        tutorialBody.innerHTML = "<div class='tutorial-header'><h1>Add Weights <sup> 4/6</sup></h1></div><h2>Turn your Imagination into reality and explore different cases</h2><h3>Click on any cell on grid to make it as weight. <br><br> Turn off weights option and reclick on cell to make it disapper, each weight is of value 10, and all empty cells in the grid have a value of 50, Helpful to test the shortest path if multiple paths are possible</h3><br><img src='../img/pathfinding_tutorial/weight.gif' alt='demo image' id='tutorial-img'>";

    } else if (tutorialPage == 5) {
        tutorialBody.innerHTML = "<div class='tutorial-header'><h1>Select Maze <sup> 5/6</sup></h1></div><h2>Built Awesome random Mazes (through recursive division algorithm) and Walls</h2><h3>Select either 'Built Maze' or 'Random Wall Maze' and have fun !</h3><br><img src='../img/pathfinding_tutorial/maze.gif' alt='demo image' id='tutorial-img'>";

    } else if (tutorialPage == 6) {
        tutorialBody.innerHTML = "<div class='tutorial-header'><h1>Visualize And Have Fun !!!<sup> 6/6</sup></h1></div><h2>After choosing algorithm and maze click on visualize button.</h2><h3>During the visualization process you can add walls and weights to see how the algorithm adapts to change, Buttons in navbar are disable during the process to avoid any mishapes </h3><br><img src='../img/pathfinding_tutorial/visualize.gif' alt='demo image' id='tutorial-img'>";
